function featureMap = makeFeatureMap2( rinclude,quantiles,summaryStatistics,sumStatNames,areaThreshold,voxelSize)
...
features = { ...
    ...
    {'StructureTensor','texture',3,'ST3',2.*sigma,sigma,2,2}
    {'StructureTensor','texture',3,'ST4',2.*sigma,2.*sigma,2,2}
    {'StructureTensor','texture',3,'ST5',3.*sigma,3.*sigma,2,2}
    {'Hessian','texture',3,'H1',sigma,2};
    {'Hessian','texture',3,'H2',2.*sigma,2};
    {'Hessian','texture',3,'H3',3.*sigma,2};
    {'Hessian','texture',3,'H4',4.*sigma,2};
    ...
    {'GaussGrad','texture',1,'GaussGrad4',4.*sigma,2};
    {'GaussGrad','texture',1,'GaussGrad5',5.*sigma,2};
    ...
    {'MaximumFilter','texture',1,'maxFilt1',3, sigma}
    {'MaximumFilter','texture',1,'maxFilt2',5, sigma}
    {'MinimumFilter','texture',1,'minFilt1',3, sigma}
    {'Area','shape',3,'area'};
