function [featureMap, keptFeatureIndices] = getFeatureIndicesOld( featureMap,varargin )
%GETFEATUREINDICESOLD Determines the necessary features and updates the
...
featureMap.border = calculateFMBorderOld(featureMap.names,featureMap.parameters,featureSelectionIndices);
