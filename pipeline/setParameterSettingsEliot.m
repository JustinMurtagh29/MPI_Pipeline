function [parameter, parameterTrain] = setParameterSettings(old_datestr)
    ...
    parameter.bbox = [1537 9216; 3201 9344; 129 1152]; % this should be aligned with KNOSSOS cubes and be divisble by tileSize 
    ...
    % Which raw dataset
    parameter.raw.root = '/zdata/manuel/data/zebrafish/1/';
    parameter.raw.prefix = 'No14-020515_mag1';
    ...
    parameter.seg.func = @seg20150326_forED;
