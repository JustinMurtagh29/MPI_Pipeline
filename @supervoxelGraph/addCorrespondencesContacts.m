function edgesCorr = addCorrespondencesContacts(p, supervoxel)
...
for m = 1:length(files)
	...
	edgesCorr = [edgesCorr; result.correspondences];

end

%save([p.correspondence.saveFolder, 'edgesCorr.mat'], 'edgesCorr');
