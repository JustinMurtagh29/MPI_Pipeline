function [parameter, parameterTrain] = setParameterSettingsBig2(old_datestr)
    ...
    parameter.saveFolder = ['/gaba/u/mberning/results/' parameter.start '/'];
    ...
    % Which raw dataset
    parameter.raw.root = '/gaba/u/kboerg/st08x2FwdPass/st08x2/mag1/';
    parameter.raw.prefix = '2012-11-23_ex144_st08x2_mag1';
