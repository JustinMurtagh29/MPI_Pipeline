...
p.saveFolder = '/tmpscratch/sahilloo/data/Mk1_F6_JS_SubI_v1/pipelineRun_mr2e_wsmrnet/';
...
p.bbox_wK = [3000, 3050, 14,15350, 16500, 5000]; 
...
p.raw.root = '/tmpscratch/jast/wKcubes/Mk1_F6_JS_SubI_v1/color/1/';
...
% Use same normalization values as in Mk1_SubI run
p.norm = struct;
p.norm.meanVal = 125.1111;
p.norm.stdVal = 48.7729;
...
p.class = struct;
p.class.root = '/tmpscratch/sahilloo/data/Mk1_F6_JS_SubI_v1/mr_2e_cont5_slurm/';
