...
load('/tmpscratch/sahilloo/data/Mk1_F6_JS_SubI_v1/pipelineRun_mr2e_wsmrnet/allParameterWithSynapses.mat')
...
cluster = Cluster.config('memory', 60, 'time', '24:00:00', 'priority',100);
