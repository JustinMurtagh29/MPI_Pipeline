...
nmlFiles = fullfile(nmlDir, ...
     ...
     'spine-head-ground-truth-24.nml','spine-head-ground-truth-25.nml','dense-typeEM-spines-01.nml'});

rng(0);
idxTrain = 1:numel(nmlFiles)-1;
idxTest = numel(nmlFiles); % box with all processes dense labeled
% load train set
curNodes = table();
gt = struct;
