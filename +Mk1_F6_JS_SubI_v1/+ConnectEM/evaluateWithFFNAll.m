...
savefig(fullfile(param.saveFolder,'connectEM',['precrec_test_FFN_all.fig']))
saveas(gcf,fullfile(param.saveFolder,'connectEM',['precrec_test_FFN_all.png']))
Util.save(fullfile(param.saveFolder,'connectEM','evaluateWithFFn_all.mat'),net)
