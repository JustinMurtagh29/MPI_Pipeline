...
% limit graph to neighbourhood sub-graph
...
gtT.shAgglo = num2cell(shAgglos);
Util.log(sprintf('Removed %d shAgglos not found in sub-graph',sum(~curMask)))
