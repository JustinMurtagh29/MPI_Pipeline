...
connLinFile = fullfile(rootDir, 'connectomeState', 'connectome_axons-04-linearized_dendrites-wholeCells-autoSpines-v1-classified-v2_SynapseAgglos-autoPreRobo-v1-classified.mat');
...
[conn, syn, connFile] = ...
    connectEM.Consistency.loadConnectome(param, connFile, connLinFile);
