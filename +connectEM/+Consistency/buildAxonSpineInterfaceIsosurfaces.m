function buildAxonSpineInterfaceIsosurfaces( ...
        param, axons, spineHeads, outDir, asiT, varargin)
    % Written by
    ...
    for curId = 1:height(asiT)
        ...
        curOutFile = sprintf('iso-%d.mat', curAsi.id);
        curOutFile = fullfile(outDir, curOutFile);
        
        doIt( ...
            info, param, opts, curAsi.pos, ...
...
function isoSurf = doIt( ...
        param, opts, pos, axonSegIds, shSegIds, outFile)
   [borders, seg, box] = ...
