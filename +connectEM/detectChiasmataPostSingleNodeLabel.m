function [output, queryIdx] = detectChiasmataPostSingleNodeLabel( ...
    ...
    % NOTE(amotta): Cluster chiasmatic nodes
    [cc, centerOfCC] = clusterNodes(nodes, isIntersection);
        ...
        for i=1:length(cc)
            [~, pos{i}, dir{i}, queryIdx{i}] = ...
                connectEM.detectChiasmataNodes( ...
                    nodes, edges, prob, p, cc{i}(centerOfCC(i)));
        end
    end
...
function [cc, centerOfCC] = clusterNodes(nodes, isIntersection)
