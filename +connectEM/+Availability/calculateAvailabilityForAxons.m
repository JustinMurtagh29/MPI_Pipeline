function targetClassAvailability = ...
        calculateAvailabilityForAxons(param, blockData, saveDists, axonIds)
    % Written by
   ...
   [blockCenters{:}] = ind2sub( ...
    ...
    for curAxonIdx = 1:numel(axonIds)
       ...
       [curDists, curSortIds] = sort(curDists, 'ascend');
        ...
        targetClassAvailability(curAxonId, :) = ...
