...
%% Analysis of conditional synapse size distribution
clear cur*;
curLog10Lims = [-1.5, 0.5];
curImSize = 256;

curTickLabels = linspace(curLog10Lims(1), curLog10Lims(2), 5);
curTickIds = linspace(curLog10Lims(1), curLog10Lims(2), curImSize);
