function axonClasses = buildAxonSpecificityClasses(conn, axonClasses)
    ...
    axonClasses(1).specs.ProximalDendrite.pThresh   = 0.058882;
    axonClasses(1).specs.ApicalDendrite.pThresh     = 0.058824;
    axonClasses(1).specs.SmoothDendrite.pThresh     = 0.029130;
    
    % Inhibitory axons
    axonClasses(2).specs = struct;
    axonClasses(2).specs.Somata.pThresh             = 0.554330;
    axonClasses(2).specs.ProximalDendrite.pThresh   = 0.272611;
    axonClasses(2).specs.ApicalDendrite.pThresh     = 0.069234;
    axonClasses(2).specs.SmoothDendrite.pThresh     = 0.065049;
    axonClasses(2).specs.AxonInitialSegment.pThresh = 0.115115;
    
    % Thalamocortical axons
    axonClasses(3).specs = struct;
    axonClasses(3).specs.ProximalDendrite.pThresh   = 0.169352;
    
    % Corticocortical axons
    axonClasses(4).specs = struct;
    axonClasses(4).specs.ApicalDendrite.pThresh     = 0.069796;
    axonClasses(4).specs.SmoothDendrite.pThresh     = 0.039980;
