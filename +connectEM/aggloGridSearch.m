...
connectEM.agglomeration( ... 
        ...
        axonProbThreshold, 0.1, spineProbThreshold, ...
        ...
        '/gaba/scratch/mberning/aggloSearch/00003.mat');

connectEM.agglomeration( ... 
        borderSizeDendrites, segmentSizeDendrites, borderSizeAxons, segmentSizeAxons, ...
        axonProbThreshold, 0, spineProbThreshold, ...
        probThresholdDendrite, sizeThresholdDendrite, probThresholdAxon, sizeThresholdAxon, ...
        erProbThreshold, ...
        dendriteProbSpines, probThresholdSpines, maxStepsSpines, ...
        '/gaba/scratch/mberning/aggloSearch/00004.mat');

connectEM.agglomeration( ... 
        300, segmentSizeDendrites, borderSizeAxons, segmentSizeAxons, ...
        axonProbThreshold, 0, spineProbThreshold, ...
        probThresholdDendrite, sizeThresholdDendrite, probThresholdAxon, sizeThresholdAxon, ...
        erProbThreshold, ...
        dendriteProbSpines, probThresholdSpines, maxStepsSpines, ...
        '/gaba/scratch/mberning/aggloSearch/00005.mat');
