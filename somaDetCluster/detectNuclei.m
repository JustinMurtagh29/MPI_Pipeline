function nucleiPost = detectNuclei( raw, vessels, visualize )
...
for z=1:sizeRaw(3)
    ...
    apicals = medfilt2(thisImage, [5 5]) > 175 & ~theseVessels;
    apicals = bwareaopen(apicals, 1200);
    ...
    theseNuclei = bwareaopen(theseNuclei, 4000, 26);
