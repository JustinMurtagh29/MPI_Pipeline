...
% combine edge data from human and macaque datasets
clear;
...
savefig(fullfile('/tmpscratch/sahilloo/data/connectEM',['precrec_test_' methodUsed '_super.fig']))
saveas(gcf,fullfile('/tmpscratch/sahilloo/data/connectEM',['precrec_test_' methodUsed '_super.png']))
