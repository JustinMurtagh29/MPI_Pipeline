...
oldMag4 = true;
outputFolder = '/tmpscratch/sahilloo/data/H2_3_v2_U1_SubI/nucleiRun8/';
if ~exist(outputFolder)
    mkdir(outputFolder);
end
dataset.root = '/tmpscratch/jast/wKcubes/H2_3_v2_U1_SubI/color/1/';
dataset.backend = 'wkwrap';
dataset.blocksize = 32;
mag1bbox_wk = [3232, 3232, 1,11136, 9472, 3584];
