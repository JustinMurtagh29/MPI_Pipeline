...
%     param.dataFolder =  'C:\data\minicube1extra\';
% else
%     param.dataFolder =  '/data/e_k0563/minicube1extra/';
% end
...
% param.skeletons = 'mini1eClean.nml'; % Skeleton file for segmentation evaluation
